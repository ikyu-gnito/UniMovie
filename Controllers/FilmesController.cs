...
namespace UniMovie.Controllers
{
    ...
    public class FilmesController : ControllerBase
    {
        ...
        // POST: api/Filmes
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
         //Responder as requisições do tipo Post, colocando as informações no banco de dados
        [HttpPost]
        public async Task<ActionResult<Filme>> PostFilme(Filme filme)
        {
            ...
            return CreatedAtAction(nameof(GetFilme), new{id = filme.Id}, filme); //Evitar o hardcode dentro do código
        }
